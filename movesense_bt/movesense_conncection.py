            ...
            for unit in units:
                if unit["name"] == "ecg":
                    ...
                    async def hr_handler(_, data):
                        d = DataView(data)
                        await self.notification_handler.notification_handler_hr(_, d, data_storage["hr"])
                    ...
                    async def imu_handler(_, data):
                        d = DataView(data)
                        await self.notification_handler.notification_handler_imu(_, d, data_storage["imu"], diff)
